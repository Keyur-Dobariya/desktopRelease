...
const endpoints = {
    ...
    employeesChange: `${environment.apiBaseUrl}/employeesChange?`,
    chatUpdates: `${environment.apiBaseUrl}/chatUpdates?`,
    ...
    getAllApps: `${environment.apiBaseUrl}/api/getAllApps`,
    getApp: `${environment.apiBaseUrl}/api/getApp`,
    addApp: `${environment.apiBaseUrl}/api/addApp`,
